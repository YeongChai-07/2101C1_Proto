...
//                        }
    ...
    <body class="container-fluid">
        ...
        <!--------------------------------- Prototype Scenario 1 : Default List ----------------------------------------------------->
        ...
        <div class="container" id="container-table">
                ...
                if (empty($_GET)) {
                    ...
                    <div class="panel panel-primary">
                        ...
                        <table class="table" id="addList" onclick="displayList()">
                            ...
                            <tr>
                                <td>Beer</td>
                                <td><form name="updateDesc"><input type="text" class="text-primary text-desc" value="Tiger"></form></td>
                                <td><form name="updateQty"><input type="text" class="text-primary text-qty"  value="4"></form></td>
                    ...
                    <div class="container">
                        <div class="row btn-update-row">
                            ...
                            <button class="btn btn-primary" type="submit" onsubmit="return updateList();">Update List</button>
            ...
            <div class="container" id="container-add">
                ...
                <form name="newShoppingListItemForm" action="ShoppingList.php" onsubmit="return checkEmptyInput();">
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-default dropdown-toggle form-control" data-toggle="dropdown" >
                            ...
                            <span data-bind="label">Select things to buy</span>&nbsp;<span class="caret"></span>

                        </button>
                        
                        <ul class="dropdown-menu" id="dropdown-add" role="menu">
                            <li name="pizza" value="pizza"><a href="#" value="pizza" name="pizza">Pizza</a></li>
                            <li><a href="#">Milo</a></li>
                            <li><a href="#">Beer</a></li>
                            <li><a href="#">Tea</a></li>
                            <li><a href="#">Meat</a></li>
                ...
                <!--------------------------------- Prototype Scenario 2 : add new item to list ----------------------------------------------------->

                <?php
            } else {
                if (isset($_GET["pizza"]) && isset($_GET["newShoppingListQty"]) || isset($_GET["newShoppingListDesc"])) {
                    ?>
                </div>
                <div class="container" id="container-table">
                    <br/><br/><br/><br/>
                    <div class="panel panel-primary">
                        ...
                        <table class="table" id="addList" onclick="displayList()">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="text-primary text-desc" value="Pokka"></td>
                                <td><input type="text" class="text-primary text-qty"  value="1"></td>
                                <td><form action="ShoppingList.php"><button name="deleteFromShoppingList" class="btn btn-danger btn-del" value="newItemToShoppingList">X</button></form></td>
                            </tr>

                            <tr>
                                <td><?php echo $_GET["pizza"]; ?></td>
                                <td><?php echo "<input type='text' class='text-primary text-desc' value='>" . $_GET["newShoppingListDesc"] . "'"; ?></td>
                                <td><?php echo "<input type='text' class='text-primary text-desc' value='>" . $_GET["newShoppingListQty"] . "'"; ?></td>
                                <td><form action="ShoppingList.php"><button name="deleteFromShoppingList" class="btn btn-danger btn-del" value="tea">X</button></form></td>
                            </tr>
                ...
                <div class="container" id="container-add">
                    ...
                    <form name="newShoppingListItemForm" action="ShoppingList.php" onsubmit="return checkEmptyInput();">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" id="dropdown-add" role="menu">
                                <li><a href="#" name="pizza">Pizza</a></li>
                                <li><a href="#">Milo</a></li>
                                <li><a href="#">Beer</a></li>
                                <li><a href="#">Tea</a></li>
                                <li><a href="#">Meat</a></li>
                    ...
                    <!--------------------------------- Prototype Scenario 3 : delete item from default ----------------------------------------------------->

                    <?php
                } else if (isset($_GET["deleteFromShoppingList"])) {
                    if ($_GET["deleteFromShoppingList"] == "tea") {
                        ?>
                    </div>
                    <div class="container" id="container-table">
                        <br/><br/><br/><br/>
                    ...
                    <div class="container" id="container-add">
                        ...
                        <?php
                    } else if ($_GET["deleteFromShoppingList"] == "newItemToShoppingList") {
                        ?>
                    </div>
                    <div class="container" id="container-table">
                        <br/><br/><br/><br/>
                        <div class="panel panel-primary">
                            ...
                            <table class="table" id="addList" onclick="displayList()">
                                ...
                                <tr>
                                    <td>Meat</td>
                                    <td><input type="text" class="text-primary text-desc" value="Air-pork"></td>
                                    <td><input type="text" class="text-primary text-qty"  value="2"></td>
                                    <td><form action="ShoppingList.php"><button name="deleteFromShoppingList" class="btn btn-danger btn-del" value="meat">X</button></form></td>
                                </tr>
